...
![image.png](getting-started/d4470698-f69b-4dfb-9dd3-8999d6afaa9b.png)
...
2. Download **Google Authenticator** or **Microsoft Authenticator** from app store
...
![image.png](getting-started/image.png)
...
![image.png](getting-started/image-1.png)
...
![image.png](getting-started/image-2.png)
...
Error Code: [Refer troubleshooting section](troubleshooting.md)
...
Basic Operations: 
•	[Modify pending orders](trading-apis.md) - Change price or quantity
•	[Cancel orders](trading-apis.md) - Cancel before execution
•	[Check your portfolio](portfolio-and-funds-apis/holdings.md) - View all holdings
•	[View positions](portfolio-and-funds-apis/positions.md) - Today's open positions
•	[Check available funds](portfolio-and-funds-apis/limits.md) - Available margin
Advanced Features:
•	[Place different order types](trading-apis.md) - Limit, Stop Loss, BO, CO
•	[Get live market quotes](market-data-apis/quotes.md) - Real-time price data
•	[Check margin requirements](portfolio-and-funds-apis/margins.md) - Before placing orders
Troubleshooting:
